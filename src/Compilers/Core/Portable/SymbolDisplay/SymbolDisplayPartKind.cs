...
namespace Microsoft.CodeAnalysis
{
    ...
    public enum SymbolDisplayPartKind
    {
        ...
        /// <summary>The name of a query conclusion variable.</summary>
        QueryConclusionVariableName = 28,
    }

    internal static class InternalSymbolDisplayPartKind
    {
        private const SymbolDisplayPartKind @base = SymbolDisplayPartKind.QueryConclusionVariableName + 1;
    ...
    internal static partial class EnumBounds
    {
        ...
        {
            return (value >= SymbolDisplayPartKind.AliasName && value <= SymbolDisplayPartKind.QueryConclusionVariableName) ||
